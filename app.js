...
const historyLayerOptions = [
  { id: "none", label: "僅現代底圖", title: "Mapbox 現代底圖", tiles: null, source: "Mapbox" },
  {
    ...
    label: "1904 堡圖",
    title: "1904 台灣堡圖",
    tiles: ["https://gis.sinica.edu.tw/tileserver/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=TaiwanForts1904&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/png"],
    source: "中央研究院 台灣百年歷史地圖"
  },
  {
    id: "land1920",
    label: "1920 地形圖",
    title: "1920 台灣地形圖",
    tiles: ["https://gis.sinica.edu.tw/tileserver/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=TaiwanTopographic1920&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/png"],
    source: "中央研究院 台灣百年歷史地圖"
  },
  {
    id: "map1921",
    label: "1921 二萬五地形圖",
    title: "1921 二萬五千分之一地形圖",
    tiles: ["https://gis.sinica.edu.tw/tileserver/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=TaiwanTopoMap1921&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/png"],
    source: "中央研究院 台灣百年歷史地圖"
  },
  {
    id: "map1944",
    label: "1944 地形圖",
    title: "1944 台灣地形圖",
    tiles: ["https://gis.sinica.edu.tw/tileserver/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=TaiwanTopographic1944&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/png"],
    source: "中央研究院 台灣百年歷史地圖"
  },
  {
    id: "map1950",
    label: "1950 臺灣地形圖",
    title: "1950 臺灣地形圖",
    tiles: ["https://gis.sinica.edu.tw/tileserver/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=TaiwanTopographic1950&STYLE=default&TILEMATRIXSET=GoogleMapsCompatible&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT=image/png"],
    source: "中央研究院 台灣百年歷史地圖"
  }
];
